...
public class FillDatabase {
	...
	public static void fillEmployee() {
		...
		try {
			...
			Employee employee1 = new Employee("andzela", "stojanoska", "andzela@seavus.com", roleManager.getRole("Employee"));
			Employee employee2 = new Employee("martin", "pehcheski", "martin@seavus.com", roleManager.getRole("Employee"));
